...
function Block4({ handleClick }: Block4Props) {
    return (
      <div className="px-4 sm:px-8 w-full mt-10">
        <div className='flex flex-col items-center justify-center w-full max-w-7xl mx-auto'>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 w-full">
            <div className="flex flex-col bg-gradient-to-br from-fuchsia-400 to-purple-500 rounded-lg shadow-lg p-6 text-white">
              ...
              <button onClick={handleClick} className="w-full bg-white text-purple-600 hover:bg-gray-100 font-medium py-2 px-4 rounded-lg transition-colors duration-300">
