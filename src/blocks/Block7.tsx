...
function Block7() {
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    return (
      <div id="formulario_contacto" className="flex flex-col items-center justify-center mt-16 w-full max-w-6xl bg-gradient-to-br from-purple-100 to-pink-100 rounded-lg shadow-lg p-10">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-2xl space-y-6">
          ...
          <div className="flex justify-center mt-8">
            <button
              type="submit"
              className="px-8 py-3 bg-gradient-to-r from-fuchsia-400 to-purple-500 text-white font-medium rounded-lg hover:opacity-90 transform hover:scale-105 transition-all duration-300 text-lg"
            >
              Enviar
            </button>
          </div>
