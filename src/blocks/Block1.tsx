...
function Block1({ handleClick }: Block1Props) {
  return (
    ...
    <div className="max-w-6xl mx-auto p-6">
        ...
        <button onClick={handleClick} className="inline-flex items-center px-5 py-3 text-sm font-medium text-center bg-pink-200 rounded-lg hover:bg-pink-500 transform hover:scale-105 transition-all duration-300 focus:ring-4 focus:outline-none focus:ring-pink-300">
            Alta Kit Digital
        </button>
        </div>
    </div>
